...
if has('nvim')
  ...
  let g:terminal_color_1  = '#e89797'
  let g:terminal_color_2  = '#97e8b9'
  let g:terminal_color_3  = '#f1e9c1'
  let g:terminal_color_4  = '#9ec7ea'
  let g:terminal_color_5  = '#9568de'
  let g:terminal_color_6  = '#97e1e8'
  let g:terminal_color_7  = '#ffffff'
  let g:terminal_color_8  = '#938f9b'
  let g:terminal_color_9  = '#e89797'
  let g:terminal_color_10 = '#97e8b9'
  let g:terminal_color_11 = '#f1e9c1'
  let g:terminal_color_12 = '#9ec7ea'
  let g:terminal_color_13 = '#9568de'
  let g:terminal_color_14 = '#97e1e8'
...
" Dark syntax colors (saturation reduced by 40%)
let s:red = '#e89797'
let s:green = '#97e8b9'
let s:yellow = '#f1e9c1'
let s:blue = '#9ec7ea'
let s:magenta = '#9568de'
let s:cyan = '#97e1e8'
let s:orange = '#edceab'
let s:pink = '#f1bdda'
let s:purple = '#c7b1ec'
